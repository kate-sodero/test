...
Most of the time, you'll be using [urdf](https://wiki.ros.org/urdf){:target="_blank"} format. If you wish to use urdf, please refer to [this guide](https://docs.isaacsim.omniverse.nvidia.com/5.0.0/importer_exporter/import_urdf.html){:target="_blank"}. In this tutorial, we'll be rigging the robot ourselves. Before starting, please download the result robot model from [**3D Model Creation**](../../stellar_designer/3dmodel_creation/index.md) guide.
